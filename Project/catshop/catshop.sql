...
--
-- Host: localhost
-- Generation Time: Dec 19, 2020 at 01:15 PM
...
(5, 'dryst', '1234', 'Phaiboon', 'Withanthamrong', 0),
...
CREATE TABLE `product` (
  ...
  `proDesc` varchar(500) CHARACTER SET tis620 COLLATE tis620_thai_ci NOT NULL,
  `proPrice` decimal(10,0) NOT NULL,
  `proAmount` decimal(10,0) NOT NULL,
  `proView` int(11) NOT NULL,
  `proPhoto` varchar(30) CHARACTER SET tis620 COLLATE tis620_thai_ci NOT NULL,
  `catId` int(11) NOT NULL,
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`catId`) REFERENCES `category` (`catId`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
